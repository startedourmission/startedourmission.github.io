...
(function () {
    ...
    const simulation = d3.forceSimulation(rawNodes)
        .force('link', d3.forceLink(links).id(d => d.id).distance(80).strength(0.45))
        .force('charge', d3.forceManyBody().strength(d => (degree.get(d.id) || 0) === 0 ? -20 : -200))
        .force('center', d3.forceCenter(width / 2, height / 2))
        .force('x', d3.forceX(width / 2).strength(d => (degree.get(d.id) || 0) === 0 ? 0.32 : 0.04))
        .force('y', d3.forceY(height / 2).strength(d => (degree.get(d.id) || 0) === 0 ? 0.32 : 0.04))
    ...
    window.addEventListener('resize', () => {
        ...
        resizeFrame = requestAnimationFrame(() => {
            ...
            simulation.force('x', d3.forceX(width / 2).strength(d => (degree.get(d.id) || 0) === 0 ? 0.32 : 0.04));
            simulation.force('y', d3.forceY(height / 2).strength(d => (degree.get(d.id) || 0) === 0 ? 0.32 : 0.04));
