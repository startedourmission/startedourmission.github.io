---
type: person
description: CUHK 교수·SenseTime 공동창업자·Shanghai AI Lab 핵심 연구자. CUHK MMLab과 OpenMMLab을 이끄는 컴퓨터비전·멀티모달 AI 대가.
tags:
  - 컴퓨터비전
  - 멀티모달
  - 교수
...
image: "![[portrait-dahua-lin-imagegen.png]]"
star: 12
---

![[portrait-dahua-lin-imagegen.png]]
...
CUHK-SenseTime 조인트 랩은 산학연 협력의 성공 사례로 꼽히며, 이 구조 덕분에 그의 연구실이 대규모 실제 데이터와 연산 자원에 접근할 수 있었습니다. 그의 지도 아래 [[돤하오둥|Haodong Duan]], Bolei Zhou, [[허카이밍|Kaiming He]] 등 다수의 저명한 연구자가 배출되었고, CUHK MMLab 동문 네트워크는 상하이 AI 연구소, NTU, 구글, 메타 등으로 퍼져 중화권 AI 연구 생태계에서 가장 넓은 동문 네트워크 중 하나로 꼽힙니다.
