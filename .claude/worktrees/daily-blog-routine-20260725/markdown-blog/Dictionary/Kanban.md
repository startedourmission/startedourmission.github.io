...
칸반(Kanban)은 원래 도요타 생산방식(Toyota Production System)에서 개발된 재고 관리 기법으로, 일본어로 "간판(看板)"을 뜻합니다. 소프트웨어 개발로의 적용은 [[데이비드 앤더슨]]이 2010년 저서 *Kanban: Successful Evolutionary Change for Your Technology Business*로 체계화했습니다.
