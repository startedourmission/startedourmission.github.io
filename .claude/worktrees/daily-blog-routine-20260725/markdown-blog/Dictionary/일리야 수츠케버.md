---
type: person
description: "OpenAI 전 수석 과학자. 지금 이끄는 SSI는 제품도 매출도 없이 기업가치 320억 달러를 인정받았다"
tags:
  - 인물
  - LLM
  - 딥러닝
...
2014년에는 seq2seq(Sequence-to-Sequence) 모델을 Oriol Vinyals, Quoc Le와 함께 발표하였습니다. 고정 길이 벡터 표현을 통해 가변 길이 입력을 가변 길이 출력으로 변환하는 이 구조는 기계 번역의 패러다임을 전환하였으며, 이후 [[트랜스포머]]와 대형 언어 모델 전반의 인코더-디코더 구조에 직접적인 영향을 주었습니다.
