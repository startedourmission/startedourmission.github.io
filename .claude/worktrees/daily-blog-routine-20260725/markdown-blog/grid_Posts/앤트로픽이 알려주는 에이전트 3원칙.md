...
글은 Anthropic 공동 창립자 [[크리스 올라]]의 통찰에서 시작합니다. 생성형 AI 시스템은 "만들어진 것이 아니라 키워진 것(grown more than they are built)"이라는 겁니다. 전통적 소프트웨어는 설계대로 동작하지만, AI 모델은 훈련을 통해 능력이 발현됩니다. 그래서 어제는 필요했던 우회 코드가 오늘은 성능을 깎는 죽은 무게(dead weight)가 됩니다.
