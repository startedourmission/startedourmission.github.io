...
투자자 구성에서도 안전 기조가 드러납니다. Google과 Amazon이 각각 수십억 달러 단위로 투자해 양대 클라우드 모두에 모델을 배포할 수 있는 구조를 만들었습니다. RLHF 대신 헌법적 AI(Constitutional AI), 정렬 평가 도구 [[Petri]] 등 안전 연구 산출물을 외부에 공개하는 점도 특징입니다.
