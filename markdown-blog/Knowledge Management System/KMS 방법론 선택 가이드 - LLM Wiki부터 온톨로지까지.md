...
description: "LLM Wiki, GraphRAG, Ontology, Agent Memory 중 무엇을 써야 할지 결정하는 실용 가이드. 개인·팀·조직 규모, 도메인 안정성, 자동화 필요도를 기준으로 선택 기준을 정리합니다."
---
...
*이 시리즈의 다른 글:*
- *[[Karpathy LLM Wiki - 개인 지식을 AI와 공유하는 새로운 방법]] — KMS 시리즈 첫 편*
