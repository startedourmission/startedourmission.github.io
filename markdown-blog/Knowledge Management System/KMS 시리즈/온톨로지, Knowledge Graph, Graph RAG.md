...
도구로는 [[Obsidian|옵시디언]], [[Roam Research]], [[Logseq]], [[Notion]] 등이 자주 쓰입니다. 노트 사이를 `[[위키링크]]`로 연결하면, 시간이 지나면서 노트들이 그래프처럼 연결됩니다. 옵시디언의 그래프 뷰가 보여주는 그것입니다.
...
| Second Brain | 개인 지식 관리 | 없음 | 사람의 사고 | 옵시디언, Roam |
