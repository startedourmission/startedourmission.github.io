...
tags:
  ...
  - 딥러닝
  - LLM
description: "머신러닝부터 트랜스포머, 딥러닝의 역사까지 — 이 블로그 하나로 AI 공부를 완결하는 순서 가이드"
---

이 블로그에는 AI를 공부하는 데 필요한 거의 모든 것이 있습니다. 문제는 어디서 시작해야 하는지 모른다는 거죠.

강의 시리즈 셋, 논문 시리즈 하나, 용어 사전 200여 개. 각각 따로 떠 있으면 산더미처럼 느껴지지만, 순서대로 보면 하나의 이야기가 됩니다. 오늘은 그 순서를 정리해드립니다.
