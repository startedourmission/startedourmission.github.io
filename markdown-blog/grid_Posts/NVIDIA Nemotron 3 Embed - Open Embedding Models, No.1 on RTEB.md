...
세 모델 모두 OpenMDW-1.1 라이선스로 공개됩니다. 8B 플래그십은 Ministral-3-8B-Instruct-2512 백본을, 1B 계열은 Ministral-3-3B-Instruct-2512 백본을 양방향 인코더로 변환한 뒤 가지치기·증류로 압축한 것입니다. Nemotron 임베딩 체크포인트 자체는 OpenMDW-1.1을 따르므로 상업적 사용 전 라이선스를 확인해야 합니다.
