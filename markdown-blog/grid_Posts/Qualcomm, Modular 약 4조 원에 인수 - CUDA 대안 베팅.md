...
딜의 핵심은 [[크리스 래트너|Chris Lattner]]가 2022년 창업한 MAX 런타임입니다. MAX는 CUDA도, ROCm도, PyTorch도 없이 [[NVIDIA]], AMD, Apple Silicon에서 동일한 코드로 AI 추론을 실행합니다. Qualcomm이 단순히 스타트업을 삼킨 게 아니라, NVIDIA의 소프트웨어 해자를 정조준하는 수직 통합 스택을 확보한 것입니다.
...
MAX의 기반은 [[크리스 래트너|Chris Lattner]]가 만든 두 가지 컴파일러 기반시설입니다.
...
9억 달러(2023년)에서 16억 달러(2025년)를 거쳐 39억 달러로 2.5배 가치가 뛴 것은 기술 때문만이 아닙니다. [[크리스 래트너|Chris Lattner]]라는 이름이 가진 신뢰도 때문입니다.
