...
**첫째, 코딩 성능입니다.** [[Terminal-Bench|Terminal-Bench 2.0]]에서 Muse Spark는 59.0점을 기록한 반면, GPT-5.4는 75.1점을 달성했습니다. 자율적 코드 생성, 멀티파일 리팩토링, 테스트 루프 실행 같은 장기 코딩 워크플로우에서 의미 있는 격차입니다. Meta 역시 코딩을 현재의 gap으로 인정하고 있습니다.
