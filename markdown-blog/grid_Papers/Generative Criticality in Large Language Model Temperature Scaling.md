...
1저자 [[Huajian Ruan]]과 교신저자 [[Xingyu Guo]]는 중국 화난사범대학(SCNU)의 핵물리·양자물질 연구 그룹 소속입니다. [[Xingyu Guo]]는 양자컴퓨팅으로 QCD를 다루는 QuNu 협업의 멤버입니다. 또 다른 교신저자 [[Lingxiao Wang]]은 RIKEN iTHEMS 연구원이자 도쿄대 지능물리학 연구소 조교수로, 딥러닝으로 QCD 역문제를 푸는 물리 기반 학습의 전문가입니다. 공저자 Jinyang Li는 일본 KEK 이론센터와 RIKEN, SOKENDAI에 걸쳐 있습니다.

격자장론과 임계현상, 통계물리를 본업으로 하는 사람들이 모였습니다. 그래서 이 논문은 "LLM이 답을 잘 맞히나"가 아니라 "LLM 출력이라는 거대한 통계 앙상블에 물리계의 상전이 같은 집단 행동이 있나"를 묻습니다. 물리학자가 신경망과 생성 모델을 장론의 언어로 해석하는 흐름([[Lingxiao Wang]]의 DEEP-IN 워킹그룹 같은) 위에 놓인 작업입니다.
