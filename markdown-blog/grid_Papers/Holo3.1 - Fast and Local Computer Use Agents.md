...
[[H Company]]는 파리의 AI 에이전트 스타트업입니다. 2024년 유럽 최대 규모의 시드 라운드를 유치했고, Runner H에 이어 오픈 웨이트 컴퓨터 유즈 VLM인 Holo 라인을 연속으로 내놓았습니다. Holo3.1의 모델링은 [[Pierre-Louis Cedoz]]가 이끕니다. 스탠퍼드와 Google, BenevolentAI를 거쳐 H Company에서 Holo-1부터 Holo3까지 라인을 이어 온 연구자입니다.
