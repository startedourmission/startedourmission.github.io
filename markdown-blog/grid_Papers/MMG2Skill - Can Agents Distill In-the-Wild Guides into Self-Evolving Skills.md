...
난징대학교와 콰이쇼우(Kuaishou Technology)가 함께한 작업입니다. 공동 1저자가 여섯 명이고, 교신저자는 난징대의 [[류자헝]]입니다.

[[류자헝]]는 난징대 NJU-LINK 랩을 이끄는 LLM 연구자로, 추론과 에이전트 평가가 전문입니다. LLM 추론을 게임으로 평가하는 KORGym의 저자이기도 합니다. 게임·에이전트 평가를 다뤄 온 이력이, GUI·게임·전략 세 도메인으로 짜인 이 논문의 벤치마크 설계와 자연스럽게 이어집니다.
