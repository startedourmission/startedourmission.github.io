...
![[markdown-blog/grid_Papers/_assets/1-FineVision.png]]
...
**훈련 방법**: 단일 단계 학습 프로토콜을 사용하며, 배치 크기 512로 20,000 스텝 동안 학습합니다(약 32 [[NVIDIA H100|H100]] GPU로 20시간). 시퀀스 패킹을 사용하여 최대 길이 8192로 설정하며, FineVision 데이터셋을 1 에폭 이상 커버합니다.
