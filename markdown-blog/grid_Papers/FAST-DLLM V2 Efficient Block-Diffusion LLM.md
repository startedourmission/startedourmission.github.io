...
**평가 메트릭**: HumanEval, MBPP(코드 생성), GSM8K, MATH(수학 추론), MMLU, [[GPQA Diamond|GPQA]](지식 집약적 QA), IFEval(명령 수행) 등 다양한 벤치마크
...
**하드웨어 확장성**: A100과 [[NVIDIA H100|H100]] GPU 모두에서 배치 크기가 증가할수록 AR 베이스라인 대비 우수한 처리량을 보였습니다. H100에서는 최대 1.8배 속도 향상을 달성했습니다.
