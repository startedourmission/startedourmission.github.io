...
### 결과
작은 네트워크들이 XOR, 가족 관계 학습(family trees), 대칭 판별 같은 작업을 학습했습니다. 은닉층이 1-2개 있어도 충분했습니다. 특히 흥미로운 점은 은닉 뉴런들이 입력의 특정 패턴을 자동으로 발견했다는 것입니다. 사람이 설계하지 않았는데도 의미 있는 표현이 생겨났습니다.
