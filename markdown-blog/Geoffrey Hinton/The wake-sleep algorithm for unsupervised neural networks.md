...
**핵심 혁신**: 비지도 학습을 두 단계로 명확히 분해했습니다. Wake phase에서 생성 모델을 학습하고, Sleep phase에서 인식 모델을 학습합니다. 레이블 없이 깊은 계층 구조를 훈련할 수 있다는 증명입니다.
...
3. 관찰된 활성화 패턴으로 생성 가중치(generative weights)를 조정합니다. 목표: "입력이 주어졌을 때 은닉 변수를 올바르게 추정하기"
...
실험 규모가 작습니다. 네트워크는 8-16개 은닉 유닛이고, 데이터는 간단한 패턴입니다. 다만 미국 우편국(USPS) 손글씨 숫자 데이터(각 숫자 700개)에서 4.8% 오류율을 달성했습니다.
