...
"루프 엔지니어링(Loop Engineering)" 같은 글에서 보듯, 그는 AI 코딩 도구를 단발 프롬프트가 아니라 자율적으로 도는 시스템 설계의 관점에서 바라본다. [[Claude Code]], Codex 같은 도구의 자동화·워크트리·서브에이전트 기능을 엮어 개발 워크플로를 구조화하는 실천적 글을 자주 쓴다.
