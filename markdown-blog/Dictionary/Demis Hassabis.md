...
데미스 허사비스(Demis Hassabis)는 영국의 AI 연구자이자 Google DeepMind의 CEO이다. 2024년 노벨 화학상 수상자이며, 같은 해 기사 작위(Knight Bachelor)를 받았다.

런던에서 태어나 체스 신동으로 유명했으며, 캠브리지 대학교에서 컴퓨터 과학을 전공한 뒤 유니버시티 칼리지 런던(UCL)에서 인지 신경과학 박사 학위를 취득하였다. 10대 시절에는 비디오 게임 개발자로도 활동하여 테마파크(Theme Park) 게임의 AI 프로그래밍에 참여하였다.
