...
장샤오치우(Shaoqiu Zhang)는 [[상하이교통대학교(SJTU)]] 소속 연구원으로, [[Microsoft]] CoreAI 프로젝트에 파견 참여하며 LLM 코딩 에이전트의 레포지토리 탐색 효율화 연구를 수행했습니다. [[왕마오취안]]과 함께 FastContext 논문의 공동 제1저자를 맡았으며, 훈련 데이터셋 구성과 SFT 파이프라인 설계를 중심적으로 담당했습니다.
