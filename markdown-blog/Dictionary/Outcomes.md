...
[[Claude Managed Agents|CMA]]에서 제공하는 기능으로, 에이전트가 자기 자신의 결과를 판단하는 대신 별도의 검증 서브에이전트(verifier)가 독립적인 컨텍스트 창에서 평가한다.
...
[[Parameter Golf]] 벤치마크에서 Outcomes를 통한 검증이 활성화되면 [[Claude Fable 5|Fable 5]]의 루프 효율이 크게 향상된다.
