...
본 논문에서는 최적화 측면 — Delta Gradient Descent, Delta Momentum, Multi-scale Momentum Muon(M3) 같은 새로운 학습 규칙의 수학적 형식화 — 을 담당했을 것으로 추정된다. 그가 USC에서 다뤄 온 신뢰 가능한 최적화의 시각이 [[Nested Learning]]에서 옵티마이저를 "연상 기억 모듈"로 재해석하는 통찰과 닿아 있다.
