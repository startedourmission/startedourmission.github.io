...
150편 이상의 논문을 상위 학회와 저널에 발표했으며, Google Scholar 피인용 수는 9,000회를 넘습니다. MinerU 오픈소스 프로젝트는 출시 1년 만에 GitHub 스타 5만 개를 달성했고, Google, Huawei, Alibaba 등 100개 이상의 기업이 프로덕션 환경에서 활용하고 있습니다.

2025년에는 상하이시 과학기술청이 선정하는 35세 이하 청년 과학자 35인 프로그램(Youth 35 Leading Program)에 선발되었습니다.
...
OpenDataLab 설립 이후 그는 InternLM 및 InternVL 시리즈의 데이터 파이프라인을 총괄했습니다. 100PB 규모의 원시 데이터를 70조 개의 고품질 토큰으로 가공하는 과정을 지휘했으며, 이 데이터 인프라는 상하이 인공지능 실험실의 LLM 및 비전-언어 모델 연구 전체를 뒷받침합니다.

Gordon Bell Prize, ACL Best Theme Paper Award, WAIC 윈판 어워드 등 주요 수상 경력을 보유하고 있으며, 현재도 박사과정 학생, 포닥, 인턴, 정규직 연구원을 적극적으로 모집하며 연구 그룹을 확장하고 있습니다.
...
- MinerU2.5: A Decoupled Vision-Language Model for Efficient Document Parsing (2025)
- MinerU2.5-Pro: Pushing the Limits of Data-Centric Document Parsing at Scale (arXiv, 2026)
- MinerU-Diffusion: Rethinking Document OCR as Inverse Rendering via Diffusion Decoding (arXiv, 2025)
- OCRBench: On the Hidden Mystery of OCR in Large Multimodal Models
- InternLM2 Technical Report (공저)
- InternVL 시리즈 데이터 파이프라인 관련 논문 (공저)
