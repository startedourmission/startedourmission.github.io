...
역전파([[Learning representations by back-propagating errors|Backpropagation]])는 신경망의 손실 함수에 대한 각 매개변수의 편미분(그래디언트)을 연쇄 법칙(chain rule)을 이용해 출력층에서 입력층 방향으로 효율적으로 계산하는 알고리즘이다.
