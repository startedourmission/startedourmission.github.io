...
[[SenseNova-U1]] 스폰서, 어드바이저 단독 1인 기재는 조직 내 그의 위상을 잘 보여 줍니다. SenseTime의 NEO-unify 라인이 Apache 2.0 기반 통합 멀티모달 모델로 재편되는 과정에서 학술-산업 간 가교 역할을 맡았으며, 핵심 연구자 상당수가 그의 연구실 출신이거나 직접 협업 관계에 있습니다.
