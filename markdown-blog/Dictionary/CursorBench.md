...
CursorBench는 [[Cursor]] 엔지니어링 팀이 자체 코딩 세션에서 추출한 과제들로 만든 사내 벤치마크다. Cursor가 자체 학습시키는 Composer 시리즈 모델을 평가하기 위해 쓰며, 공개된 [[SWE-bench]]·[[Terminal-Bench]]와 함께 모델 발표에 같이 실리는 세 번째 축이다.
