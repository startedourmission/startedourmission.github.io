...
이후 [[호주국립대학교]](ANU) 컴퓨터과학대학 교수로 부임했으며, 2020년대 초부터 [[Google DeepMind]] 시니어 리서치 사이언티스트를 겸직하고 있습니다. DeepMind 런던 오피스와 ANU 캔버라 소속을 함께 유지하며 이론 AI 연구를 이어가고 있습니다. 2025년에는 ANU에서 열린 AI 컨퍼런스에서 발표했으며, 2024년에는 Universal AI 입문서 개정판을 출간하여 2005년 초판 이후 20년간의 연구 진전과 ASI 안전 챕터를 추가했습니다.
...
2006년에는 허터상(Hutter Prize)을 개설했습니다. 영어 위키피디아 텍스트 1GB를 최소 크기로 무손실 압축하는 알고리즘에 최대 50만 유로를 수여하는 대회로, "압축 = 예측 = 지능"이라는 핵심 아이디어를 실험적으로 검증하기 위한 것입니다. 2023년에는 Saurabh Kumar가 1억 1,400만 바이트(원본의 11.41%)까지 압축하는 기록을 세웠으며, LLM 시대에 들어서도 이 대회의 기록은 꾸준히 경신되고 있습니다.

2026년 6월에는 [[셰인 레그]] 등 [[Google DeepMind]] 연구자 14인과 공저한 [[From AGI to ASI]] 보고서를 발표했습니다. AGI 이후 ASI(초지능)로 전환하는 경로와 위험을 분석한 57페이지짜리 논문으로, AIXI 이론이 핵심 이론적 배경으로 등장합니다.
