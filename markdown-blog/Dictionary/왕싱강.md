...
[[Vision Mamba]](Vim)는 순수 상태 공간 모델(SSM) 기반의 비전 백본 연구로, ICML 2024에서 2,609편 중 2위에 선정될 만큼 반향이 컸습니다. [[YOLO-World]]는 개방형 어휘 실시간 객체 검출 연구이며, [[LightningDiT]]는 확산 트랜스포머의 학습 효율을 대폭 개선하는 연구입니다. 최근에는 [[쉬쯔양|Ziyang Xu]], [[돤캉성|Kangsheng Duan]] 등 지도 학생들의 이미지 인페인팅 연구([[PixelHacker]], [[Moebius]])에서 교신저자로 기여하고 있습니다.
