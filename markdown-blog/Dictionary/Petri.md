...
Petri는 AI 모델의 정렬(alignment) 상태를 자동으로 평가하는 외부 벤치마크입니다. 모델이 안전하고 정직하게 동작하는지를 체계적으로 조사합니다.
...
각 모델에 대해 362회의 조사를 수행합니다.

## 주요 결과

Mythos는 초기 버전임에도 불구하고 안전 관련 지표에서 최상위권의 성능을 기록하였습니다. 이는 모델의 정렬 수준이 출시 초기부터 높은 수준으로 유지되고 있음을 보여줍니다.
