![Cover image](https://pbs.twimg.com/media/HPrICelXIAAsh1f.jpg)

Grok [@bot](https://x.com/bot) just dropped. I downloaded it on a Mac the same day and recorded myself setting it up. This is the getting started version of that. Not a feature list. What I actually clicked, what worked, and which bots I would create if I were you.
...
I first added the coding bot and linkedin and X bot and email bot and later added a **video editor** (Screen Studio recuts, thumbnails, audio), a **YouTube bot** for posting the videos I create so I don't have to (unlisted first), a **blog post bot** ([debbie.codes](https://x.com/debs_obrien/status/debbie.codes) then [Dev.to](https://x.com/debs_obrien/status/Dev.to), LinkedIn and Twitter), and a **travel** bot for conference weeks. Then I added my **chief of staff** to manage them all but you could totally start with the chief of staff.
...
Video is here if you want to watch. [https://www.youtube.com/watch?v=kiDvQnoCveU&t=1312s](https://www.youtube.com/watch?v=kiDvQnoCveU&t=1312s)
